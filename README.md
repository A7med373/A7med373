...
### Атрибуция конверсий: Директ x Метрика x WB
...
- Интеграция с проприетарным API GPS/геотрекера.
- Прием, обработка и хранение координат оборудования.
- Фронтенд с интерактивной картой и обновлением данных.
- Обработка потоковых данных и нестандартных HTTP-сценариев интеграции.

Публичный MVP: [GpsTrack](https://github.com/A7med373/GpsTrack). Финальная версия проекта приватная.
