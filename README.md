...
Делаю backend-сервисы, интеграции и фоновые процессы с упором на надежность, понятную архитектуру и измеримый результат. Мне близки продуктовые команды, где важны качество кода, тесты и аккуратная работа с данными.
